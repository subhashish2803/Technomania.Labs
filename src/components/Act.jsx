...
function Act() {
  ...
  return (
    <div className='min-h-screen'>
      {/* Hero Section */}
      <div className="bg-green-300 text-black md:p-12 rounded-md shadow-2xl m-4 bg-cover bg-center bg-no-repeat py-12 px-4">
        ...
        <button
          ...
          className="bg-green-300 text-black font-semibold px-5 py-3 rounded-md border border-white hover:bg-green-100 transition flex items-center gap-2"
        >
