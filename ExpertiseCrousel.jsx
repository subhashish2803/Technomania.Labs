...
const ExpertiseCarousel = () => {
  const expertiseItems = [
    ...
    {
      title: "Salesforce",
      description: "Leverage our value-added Salesforce consulting services to unlock the true potential of your Salesforce. Our certified Salesforce consultants are backed by a combined 12+ years of experience in SFDC consulting, integration, customization, and support.",
    },
    {
    ...
    },
    {
      ...
      description: "Our expertise in Wallet Connect allows for secure and decentralized communication between wallets and dApps, enhancing the user experience.",
    },
  ];
  ...
  return (
    <div id="our_expertise" className="expertise mx-auto p-6 bg-white">
      <h2 className="text-3xl lg:text-4xl text-black font-sans text-center mb-6 md:mb-14 lg:mb-20">
        Our Expertise
      </h2>
      ...
      >
        {expertiseItems.map((item, index) => (
          <div
            key={index}
            className="bg-black dark:bg-slate-900 dark:bg-gradient-to-l from-gray-200 via-fuchsia-200 shadow-lg rounded-lg p-6 md:p-10 flex flex-col justify-between items-center mb-6 mx-4"
